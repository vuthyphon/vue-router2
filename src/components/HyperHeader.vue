            ...
            <div class="flex flex-1 items-center justify-end md:justify-between">
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/about"> {{ $t('about') }} </router-link>
                        </li>

                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/careers"> {{ $t('careers') }} </router-link>
                        </li>

                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/history"> {{ $t('history')}} </router-link>
                        </li>

                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="services"> {{$t('services')}} </router-link>
                        </li>

                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/projects"> {{$t('projects')}} </router-link>
                        </li>

                        <li>
                            <router-link class="text-gray-500 transition hover:text-gray-500/75" to="/users"> {{$t('users')}} </router-link>
                        </li>

                        <li>
                            <a class="text-gray-500 transition hover:text-gray-500/75" href="#"> {{$t('blogs')}} </a>
                        </li>
                        <li>
